...
class Enquiry extends Model {
  ...
  const Enquiry._internal({required this.id, required name, description, required isComplete, createdAt, updatedAt}): _name = name, _description = description, _isComplete = isComplete, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Enquiry({String? id, required String name, String? description, required String isComplete}) {
  ...
  String toString() {
    ...
    buffer.write("isComplete=" + "$_isComplete" + ", ");
  ...
  Enquiry copyWith({String? id, String? name, String? description, String? isComplete}) {
    return Enquiry._internal(
      id: id ?? this.id,
      name: name ?? this.name,
