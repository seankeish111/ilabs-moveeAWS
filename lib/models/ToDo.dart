...
class Todo extends Model {
  ...
  factory Todo({String? id, required String name, String? description, required String isComplete}) {
  ...
  Todo copyWith({String? id, String? name, String? description, String? isComplete}) {
    return Todo._internal(
      id: id ?? this.id,
      name: name ?? this.name,
